...
public class DinnerActivity extends AppCompatActivity implements MenuAdapter.AdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        value = intent.getIntExtra("dinner", -1);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedFood.size() == 0) {
                    Toast.makeText(DinnerActivity.this, "Nisi odabrao namirnicu", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent = new Intent(DinnerActivity.this, TotalActivity.class);
                    intent.putExtra("valueDinner", value);
    ...
    private void editTaskDialog(final Food clickedFood, int position) {
        ...
        builder.setPositiveButton("Prihvati", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (gram <= 0) {
                    Toast.makeText(DinnerActivity.this, "Unio si krivu masu. Unesi broj veči od 0", Toast.LENGTH_SHORT).show();
                } else {
