...
public class FoodDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO " + FoodEntry.TABLE_NAME + " (" +
                ...
                "VALUES " +
                "('Ajvar', 0.036, 0.036, 0, 0.014, 0.064, 0.64), " +
                "('Cajna pašteta', 0.29, 0.03, 0.03, 0.14, 0.02, 3.25), " +
                "('Cvarci', 0.712, 0, 0, 0.26, 0, 7.44), " +
                "('Govedina - prsa', 0.205, 0.009, 0, 0.168, 0, 2.52), " +
                "('Govedina - masna', 0.266, 0.132, 0, 0.218, 0, 3.27), " +
                "('Guska - masna', 0.42, 0, 0, 0.219, 0, 4.72), " +
                "('Hamburger goved.', 0.185, 0.037, 0, 0.168, 0, 2.34), " +
                "('Hrenovke pileće', 0.196, 0.04, 0, 0.129, 0.068, 2.58), " +
                "('Hrenovke pureće', 0.23, 0, 0, 0.14, 0, 2.63), " +
                "('Janjetina', 0.23, 0.006, 0, 0.18, 0, 2.79), " +
                "('Jetrena pašteta', 0.29, 0.03, 0.03, 0.14, 0.02, 3.25 ), " +
                "('Jogurt light 0.9% m.m', 0.009, 0.001, 0, 0.043, 0.051, 0.46), " +
                "('Jogurt tekući 2.8% m.m', 0.028, 0.001, 0, 0.043, 0.051, 0.63), " +
                "('Jogurt voćni 0.7% m.m', 0.007, 0.005, 0, 0.028, 0.072, 0.47), " +
                "('Juneći but', 0.167, 0.006, 0, 0.233, 0, 2.43), " +
                "('Kobasice kranjske', 0.374, 0.028, 0, 0.142, 0, 3.94), " +
                "('Kobasice svinj. - pečenice', 0.338, 0.038, 0, 0.143, 0, 3.61), " +
                "('Kobasice svinj. - suhe', 0.473, 0.054, 0, 0.213, 0, 5.13), " +
                "('Krvavice', 0.382, 0.04, 0, 0.164, 0.013, 4.22), " +
                "('Lignje panirane', 0.082, 0, 0, 0.117, 0.23, 2.15), " +
                "('Mesni narezak - svinj.', 0.40, 0.04, 0.04, 0.12, 0.04, 4.24), " +
                "('Mesni narezak - svinj. + goved.', 0.16, 0.04, 0.03, 0.13, 0.04, 3.38), " +
                "('Mlijeko 1.5% m.m', 0.015, 0.001, 0.001, 0.034, 0.048, 0.46), " +
                "('Mlijeko 2.8% m.m', 0.028, 0.001, 0, 0.033, 0.047, 0.57), " +
                "('Mlijeko 3.2% m.m', 0.032, 0.001, 0, 0.033, 0.047, 0.60), " +
                "('Pureća kobasica', 0.20, 0, 0, 0.16, 0, 2.52), " +
                "('Sir Cheddar', 0.33, 0.01, 0.01, 0.25, 0.01, 4.01), " +
                "('Sir Ementaler', 0.30, 0.09, 0.01, 0.30, 0, 3.86), " +
                "('Sir Feta', 0.20, 0.005, 0.003, 0.142, 0.04, 2.53), " +
                "('Vratina - sušena', 0.402, 0.046, 0, 0.208, 0.014, 4.50);"
        );
